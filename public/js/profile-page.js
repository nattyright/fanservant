...
function loadServantProfile(a) {
  ...
  for (let key in a.profile) {
    if (a.profile[key].startsWith("[LOCK]")) {
      ...
      document.getElementById('pf-profile-profile1').previousElementSibling.previousElementSibling.src = '<img class="panel-img" src="assets/profile-infopanel-top-mid-locked.png">';
